    ...
    public function index()
{
    ...
    $commentThisMonth = Comment::whereBetween('created_at', [$startOfThisMonth, $endOfThisMonth])->count();
    ...
    $commentLastMonth = Comment::whereBetween('created_at', [$startOfLastMonth, $endOfLastMonth])->count();
    ...
    $growthComment = $commentLastMonth > 0
    ? round((($commentThisMonth - $commentLastMonth) / $commentLastMonth) * 100)
    : ($commentThisMonth > 0 ? 100 : 0);
